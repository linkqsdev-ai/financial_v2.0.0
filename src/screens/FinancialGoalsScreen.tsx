    ...
    <View style={{ flex: 1, backgroundColor: SURFACE_GRAY }}>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: '700', color: NAVY, fontFamily: 'System' }}>Goals</Text>
        </View>
      ...
      <ScrollView
        contentContainerStyle={{ paddingTop: 80, paddingBottom: 110, paddingHorizontal: 16 }}
      ...
      >
        ...
        <View style={{
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <Text style={{ fontSize: 11, fontWeight: '600', color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase', letterSpacing: 1.5 }}>Global Status</Text>
            <View style={{ backgroundColor: CHAMPAGNE, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 99 }}>
              <Text style={{ fontSize: 9, fontWeight: '700', color: ROYAL_NAVY, textTransform: 'uppercase' }}>Pro</Text>
            </View>
          </View>
          <Text style={{ fontSize: 22, fontWeight: '700', color: '#fff', marginBottom: 6, fontFamily: 'System' }}>2 on track, 1 needs attention</Text>
          <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', fontFamily: 'System', lineHeight: 20 }}>
        ...
        <View style={{ gap: 16 }}>
          ...
          <View style={styles.goalCard}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                ...
                <View>
                  <Text style={{ fontSize: 18, fontWeight: '700', color: NAVY, fontFamily: 'System' }}>Retirement</Text>
                  <Text style={{ fontSize: 12, color: OUTLINE, marginTop: 2, fontFamily: 'System' }}>Target: 2045</Text>
                </View>
              </View>
              <View style={{ backgroundColor: 'rgba(52,199,89,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99 }}>
                <Text style={{ fontSize: 11, fontWeight: '700', color: GREEN, textTransform: 'uppercase', letterSpacing: 0.5 }}>On Track</Text>
              </View>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 6 }}>
                <Text style={{ fontSize: 20, fontWeight: '700', color: NAVY }}>
                  ₹3.2L <Text style={{ fontSize: 13, color: OUTLINE, fontWeight: '400' }}>/ ₹5L</Text>
                </Text>
                <Text style={{ fontSize: 12, fontWeight: '700', color: NAVY }}>42%</Text>
              </View>
              <View style={{ height: 8, backgroundColor: SURFACE_GRAY, borderRadius: 4, overflow: 'hidden' }}>
                <View style={{ width: '42%', height: '100%', backgroundColor: ROYAL_NAVY, borderRadius: 4 }} />
              </View>
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <MaterialIcons name="trending-up" size={16} color={GREEN} />
              <Text style={{ fontSize: 13, fontWeight: '600', color: GREEN }}>Growth +12.4% this year</Text>
            </View>
          </View>
          ...
          <View style={styles.goalCard}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                ...
                <View>
                  <Text style={{ fontSize: 18, fontWeight: '700', color: NAVY, fontFamily: 'System' }}>Emergency Fund</Text>
                  <Text style={{ fontSize: 12, color: OUTLINE, marginTop: 2, fontFamily: 'System' }}>6 months of expenses</Text>
                </View>
              </View>
              <View style={{ backgroundColor: 'rgba(52,199,89,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99 }}>
                <Text style={{ fontSize: 11, fontWeight: '700', color: GREEN, textTransform: 'uppercase', letterSpacing: 0.5 }}>On Track</Text>
            ...
            <View style={{ marginBottom: 12 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 6 }}>
                <Text style={{ fontSize: 20, fontWeight: '700', color: NAVY }}>
                  ₹4.25L <Text style={{ fontSize: 13, color: OUTLINE, fontWeight: '400' }}>/ ₹5L</Text>
                </Text>
                <Text style={{ fontSize: 12, fontWeight: '700', color: NAVY }}>85%</Text>
              </View>
              <View style={{ height: 8, backgroundColor: SURFACE_GRAY, borderRadius: 4, overflow: 'hidden' }}>
                <View style={{ width: '85%', height: '100%', backgroundColor: ROYAL_NAVY, borderRadius: 4 }} />
              </View>
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <MaterialIcons name="check-circle" size={16} color={OUTLINE} />
              <Text style={{ fontSize: 13, color: OUTLINE, fontWeight: '600' }}>Nearly fully funded</Text>
            </View>
          </View>
          ...
          <View style={[styles.goalCard, { borderWidth: 1, borderColor: 'rgba(255,59,48,0.2)' }]}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                <View style={{ width: 44, height: 44, borderRadius: 12, backgroundColor: 'rgba(0,17,58,0.06)', alignItems: 'center', justifyContent: 'center' }}>
                  <MaterialIcons name="school" size={26} color={NAVY} />
                </View>
                <View>
                  <Text style={{ fontSize: 18, fontWeight: '700', color: NAVY, fontFamily: 'System' }}>Child Education</Text>
                  <Text style={{ fontSize: 12, color: OUTLINE, marginTop: 2, fontFamily: 'System' }}>Target: 2038</Text>
                </View>
              </View>
              <View style={{ backgroundColor: 'rgba(255,59,48,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99 }}>
                <Text style={{ fontSize: 11, fontWeight: '700', color: RED, textTransform: 'uppercase', letterSpacing: 0.5 }}>Behind</Text>
              </View>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 6 }}>
                <Text style={{ fontSize: 20, fontWeight: '700', color: NAVY }}>
                  ₹2.7L <Text style={{ fontSize: 13, color: OUTLINE, fontWeight: '400' }}>/ ₹15L</Text>
                </Text>
                <Text style={{ fontSize: 12, fontWeight: '700', color: NAVY }}>18%</Text>
              </View>
              <View style={{ height: 8, backgroundColor: SURFACE_GRAY, borderRadius: 4, overflow: 'hidden' }}>
                <View style={{ width: '18%', height: '100%', backgroundColor: RED, borderRadius: 4 }} />
              </View>
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <MaterialIcons name="warning" size={16} color={RED} />
              <Text style={{ fontSize: 13, fontWeight: '600', color: RED }}>₹15,400 monthly gap detected</Text>
            </View>
          </View>
          ...
          <TouchableOpacity style={{
            ...
            <MaterialIcons name="add-circle" size={24} color={OUTLINE} />
            <Text style={{ fontSize: 11, fontWeight: '600', color: OUTLINE, textTransform: 'uppercase', letterSpacing: 1 }}>Create New Goal</Text>
          </TouchableOpacity>
        ...
        <View style={{
          ...
          <View style={{ flexDirection: 'row', gap: 14 }}>
            <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: CHAMPAGNE, alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <MaterialIcons name="star" size={22} color="#fff" />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 17, fontWeight: '700', color: NAVY, fontFamily: 'System' }}>Inflation-Adjusted Goals</Text>
              <Text style={{ fontSize: 14, color: OUTLINE, marginTop: 4, lineHeight: 18, fontFamily: 'System' }}>
                Pro users can track real progress by factoring in 6% annual inflation automatically.
              </Text>
              <TouchableOpacity style={{ alignSelf: 'flex-start', backgroundColor: ROYAL_NAVY, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10, marginTop: 12 }}>
                <Text style={{ fontSize: 11, fontWeight: '700', color: WHITE, textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'System' }}>Upgrade to Pro</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
